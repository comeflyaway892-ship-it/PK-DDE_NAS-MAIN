...
class ArchResults(object):
  ...
  def get_metrics(self, dataset, setname, iepoch=None, is_random=False):
    """
      ...
      If not specify, each set refer to the proposed split in NAS_Bench_201 paper.
...
I did not write much comment for this class, because it is the lowest-level class in NAS_Bench_201 API, which will be rarely called.
...
class ResultsCount(object):
  ...
  def get_config(self, str2structure):
    ...
    if str2structure is None:
      # In this case, this is NAS_Bench_301
      ...
      # In this case, this is NAS_Bench_201
      else:
