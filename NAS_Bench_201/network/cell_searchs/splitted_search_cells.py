...
# This module is used for NAS_Bench_201, represents a small search space with a complete DAG
class Splitted_NAS201SearchCell(nn.Module):

  def __init__(self, C_in, C_out, stride, max_nodes, op_names, affine=False, track_running_stats=True):
    super(Splitted_NAS201SearchCell, self).__init__()
