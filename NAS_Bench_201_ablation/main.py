...
from experiments import exp_with_fixed_seed_in_nb201, exp_with_rand_seed_in_nb201, exp_with_fixed_seed_in_meta_predictor, exp_with_rand_seed_in_meta_predictor, test_top10
def main(args):
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='imagenet',help='cifar10, cifar100, imagenet, aircraft, pets')

    args = parser.parse_args()
    main(args)
   # test_top10(dataset='aircraft')