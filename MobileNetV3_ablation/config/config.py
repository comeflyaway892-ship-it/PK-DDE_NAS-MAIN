...
MOBILENETV3_ABLATION_ROOT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
...
def _a(*parts):
    return os.path.join(MOBILENETV3_ABLATION_ROOT, *parts)
...
# Use the original data folder directly. Do not stage or copy datasets here.
...
meta_hyper_params_setting = {
    "cifar10": {
        "num_step": 100,
        "population_num": 50,
        "save_dir": _a("results", "meta", "cifar10") + os.sep,
        "seed": list(range(10)),
    },
    "cifar100": {
        "num_step": 100,
        "population_num": 50,
        "save_dir": _a("results", "meta", "cifar100") + os.sep,
        "seed": list(range(10)),
    },
    "aircraft": {
        "num_step": 100,
        "population_num": 50,
        "save_dir": _a("results", "meta", "aircraft") + os.sep,
        "seed": list(range(10)),
    },
    "pets": {
        "num_step": 100,
        "population_num": 50,
        "save_dir": _a("results", "meta", "pets") + os.sep,
        "seed": list(range(10)),
    },
}
